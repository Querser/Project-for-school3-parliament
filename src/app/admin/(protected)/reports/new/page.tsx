  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <AdminPageHeader title="Новый отчет" description="Добавьте отчет и публикационные метаданные." />
      ...
      <form action={createReportAction} className="space-y-4 rounded-lg border border-slate-200 bg-white p-6">
        ...
        <label className="block space-y-1 text-sm">
          ...
          <Input name="periodLabel" placeholder="Например: Март 2026" required />
        </label>

        <label className="block space-y-1 text-sm">
          <span className="font-medium text-slate-700">Текст отчета</span>
          <Textarea name="content" className="min-h-40" required />
        </label>
        ...
        <label className="block space-y-1 text-sm">
          <span className="font-medium text-slate-700">Файл отчета (опционально)</span>
